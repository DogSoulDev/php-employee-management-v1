    ...
    <nav class="navbar navbar-expand bg-light navbar__container">
        <div class="container-fluid">
            ...
            <div class="navbar">
                ...
                <a class="navlinks" href="http://127.0.0.1/php-employee-management-v1/src/employee.php">Employees</a>
                <a type="button" class="navlinks" id="logoutBtn"
                    href="http://127.0.0.1/php-employee-management-v1/src/library/logout.php">LogOut</a>
